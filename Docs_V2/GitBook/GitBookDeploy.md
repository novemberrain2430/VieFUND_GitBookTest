...
Phải cài app gitbook cho github trước rồi mới kết nối, nếu không sẽ không tìm thấy được repo
...
|--------|-------------|-------------|
| Sidebar trống / không đúng | `SUMMARY.md` thiếu hoặc sai cú pháp | Kiểm tra format: `* `[Title](#)`` |
