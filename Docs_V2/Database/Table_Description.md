...
> Mo ta y nghia, cach su dung, tai lieu tham khao cua cac column trong database VieFUND.
> Duoc tao tu dong tu `Tables.sql` voi chu thich dua tren naming convention va business logic.
