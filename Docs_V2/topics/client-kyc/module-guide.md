...
> **Nguồn**: [Client Access Right, Plan's account type.md](../../business-logic-topics/client-access-rights.md)
...
> **Nguồn**: [RepCode Explained](../../business-logic-topics/repcode-explained.md) — "Mỗi Client gắn với 1 repcode"
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md) — "A and T are industry standard value for Account Status"
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L2362-2384 — logic phân nhánh theo `Title`
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md)
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) L38-147 (Search), L197-244 (GetClientDataSet), L2261-2751 (ClientAddUI)
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) L197-244 — `GetClientDataSet()` và L234-242 (table naming logic)
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md) — "KYC info on the plan level is for the plan, and the KYC info on the client level is for the client"
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) L245-291 — `GetClientKYCSet()`
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L687-800 — FinInfo table loading
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) L2643-2699
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md) — "Plan is a group of accounts with similar characteristics"
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md) — "Joint Plan and Spousal Plan have nothing to do with each other"
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) — methods `GetClientPlanList()`, `GetPlanDataSet()`, `GetPlanMFList()`
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) L293-378
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L97-373 — Tab declarations
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L374-451 — `SetDefault()`
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L606-608 — `LockAddressField()`
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) — methods cuối file
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L270-274, [Customer.cs](../../UBClasses/Customer.cs) L2545-2547
...
> **Nguồn**: [Customer.cs](../../UBClasses/Customer.cs) — extracted via `db.SetSP("...")` pattern
...
> **Nguồn**: [Client Access Right.md](../../business-logic-topics/client-access-rights.md) — "Joint reps: when 2 or more reps share commissions"
...
> **Nguồn**: [PopupClientAdd.aspx.cs](../../WebApp/Main/PopupClientAdd.aspx.cs) L99, L361-362
