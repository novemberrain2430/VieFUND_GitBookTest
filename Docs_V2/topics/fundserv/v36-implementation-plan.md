...
| File | Thay đổi |
|---|---|
| [PopupFundServ.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundServ.aspx.cs) | Parse và hiển thị 4 deduction fields mới khi import TS/FS file data |
| [PopupFundServ_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundServ_FR.aspx) | Bản FR tương ứng |
| [CommissionView.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/CommissionView.aspx) / [.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/CommissionView.aspx.cs) | Thêm rows cho 4 loại fee mới trong Payable summary |
| [CommissionView_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/CommissionView_FR.aspx) | Bản FR tương ứng |
| [SettlementView.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/SettlementView.aspx.cs) | Parse new deduction fields từ Settlement data |
| [TSHImportView.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/TSHImportView.aspx.cs) | Import TS/HS file – parse 4 fields mới |
| [FundSetup.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FundSetup.aspx.cs) | Nếu hiển thị deduction breakdown |
...
| File | Thay đổi |
|---|---|
| [PopupPlanAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAdd.aspx.cs) | Validation: nếu jurisdiction = QC & Joint → restrict Survivor Type = "T" only |
| [PopupAccountAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupAccountAdd.aspx.cs) | Tương tự validation |
| [PopupPlanAddBody.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAddBody.aspx) / [_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAddBody_FR.aspx) | UI warning cho QC Joint |
...
| File | Thay đổi |
|---|---|
| [PanelClientIdentAdd.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelClientIdentAdd.aspx) / [_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelClientIdentAdd_FR.aspx) | Cập nhật dropdown text cho value "C" |
| [PanelClientIdentAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelClientIdentAdd.aspx.cs) | Nếu dropdown populate programmatically |
| [FINTRACView.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FINTRACView.aspx) / [_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FINTRACView_FR.aspx) | Cập nhật display label |
...
| File | Thay đổi |
|---|---|
| [PanelFeeRedemptionOrder.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelFeeRedemptionOrder.aspx.cs) | Bỏ restriction chỉ Nominee/Intermediary – cho phép Client Name |
| [PanelFeeProcess.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelFeeProcess.aspx.cs) | Fee processing – mở rộng scope |
| [PanelFeeAddItem.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelFeeAddItem.aspx.cs) | Fee add – mở rộng scope |
| [PopupTradeAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupTradeAdd.aspx.cs) | Trade placement – allow fee redemption for AcctDesig=1 |
| [PopupTradeBasket.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupTradeBasket.aspx.cs) | Trade basket – allow Client Name fee redemptions |
| [TrxView.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/TrxView.aspx.cs) | Transaction view filter |
...
| File | Thay đổi |
|---|---|
| [PopupPlanAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAdd.aspx.cs) | **Quan trọng nhất**: Thêm FHSA (type=22) vào account type check cho successor |
| [PopupPlanAddBody.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAddBody.aspx) / [_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAddBody_FR.aspx) | Đổi label "TFSA/RRIF Successor" → "Successor" |
| [PanelTFSAEdit.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelTFSAEdit.aspx) / [.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelTFSAEdit.aspx.cs) | Đổi tên references, mở rộng scope |
| [PopupPlanViewAccInfo.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanViewAccInfo.aspx.cs) | Hiển thị successor cho RRIF/FHSA |
| [PanelPlanBenAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelPlanBenAdd.aspx.cs) | Death Beneficiary validation cho RRIF/FHSA requirement |
| [PopupFundServ.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundServ.aspx.cs) | Parse renamed `Sucsr` (thay vì `TFSASucsr`) từ TS/HS/NS files |
...
## 6. Minimizing Data Exchange – Phase 1 (DOT 165) – myserv only
...
> Chỉ cần thay đổi phía Dealer **nếu WebApp có tích hợp trực tiếp với myserv**.

| File/Area | Thay đổi |
|---|---|
| Nếu có myserv integration | Parse `SINPartial` (4 digits) thay vì `SIN` (9 digits) |
| Nếu có myserv integration | Parse `BkAcctNumPartial` (4 chars) thay vì `BkAcctNum` |
| Nếu có myserv integration | Không gửi SIN trong Account Inquiry requests |
| Nếu có myserv integration | Xóa IDVerify parsing cho Owner và JntOwner |
| Privacy best practice | Xem xét mask SIN trên tax receipt PDFs |
...
| File | Thay đổi |
|---|---|
| [FundSetup.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FundSetup.aspx.cs) | Cập nhật Product Type dropdown/validation |
| [FundSetupBody.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FundSetupBody.aspx) / [_FR.aspx](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/FundSetupBody_FR.aspx) | UI updates |
| [PopupFundDefAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundDefAdd.aspx.cs) | Fund definition add |
| [PopupFundDefEdit.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundDefEdit.aspx.cs) | Fund definition edit |
...
| File | Thay đổi |
|---|---|
| [SettlementView.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/SettlementView.aspx.cs) | GS file parser – tăng field length cho AmtValue |
...
> [!IMPORTANT]
> 1. WebApp có tích hợp trực tiếp với **myserv** không? Nếu có, section 6 sẽ cần nhiều thay đổi.
> 2. Xác nhận database schema hiện tại cho `Deductions` table – có sẵn columns nào?
> 3. FD/MD file processing có được thực hiện trong WebApp hay hệ thống khác?
> 4. Có cần backward compatibility không (hỗ trợ cả V35 và V36 cùng lúc)?
> 5. Theo V36_req.md, **Phase 2** data minimization (TFS/NFU) nằm trong V37 (2027). Xác nhận không cần thay đổi TFS/NFU data fields trong V36 release này.
