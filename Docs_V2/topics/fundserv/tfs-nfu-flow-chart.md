...
**File**: [PopupOrderBatch.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupOrderBatch.aspx.cs)
...
**File**: [VieFUNDIE.cs](file:///c:/Users/NR/Desktop/VieFundAG/VieFUNDIE/VieFUNDIE.cs) → `OnTimer()` (L654)
...
**File**: [COrder.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/COrder.cs)

`OrderFileGenerate()` (L86):
1. Calls SP `UBOrderCreateFile` — returns `FileName`, `OrderMSG` (XML body), `iVersion`, `bLTI`
2. The SP assembles XML from order data in DB using classes from [TS_Export.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBExport/TS_Export.cs)
...
**File**: [COrder.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/COrder.cs) → `GetFSVersion()` (L20)
...
**File**: [PopupOrderBatch.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupOrderBatch.aspx.cs) — Tab "NFU"
...
**File**: [CXM.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/CXM.cs)
...
- [PopupPlanAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupPlanAdd.aspx.cs) — Account Setup (New Account, Successor, etc.)
- [PopupAccountAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupAccountAdd.aspx.cs) — Account modifications
- [PanelTFSAEdit.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelTFSAEdit.aspx.cs) — TFSA Successor edits
- [PanelPlanBenAdd.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PanelPlanBenAdd.aspx.cs) — Beneficiary updates

These pages call `CNFU.AddNFU()` ([NFU.cs:L458](file:///c:/Users/NR/Desktop/VieFundAG/UBClasses/NFU.cs#L458)) which calls SP `UBNFUAdd` to queue the NFU message.
...
- Configurable via WebApp: [PopupFundServ.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupFundServ.aspx.cs) → `idFundServUploadPath`
...
|---|---|---|
| **DR** (Order Response) | [COrder.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/COrder.cs) `ImportXML()` | `UBXMLRecOrderRespnProcess` |
| **XR** (NFU Response) | [CXM.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/CXM.cs) `ImportXML()` | `UBXMLRecNFURespnProcess` |
...
**File**: [TS_Export.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBExport/TS_Export.cs)
...
|---|---|---|
| **UI (WebApp)** | [PopupOrderBatch.aspx.cs](file:///c:/Users/NR/Desktop/VieFundAG/WebApp/Main/PopupOrderBatch.aspx.cs) | Same file, NFU tab |
| **Business Logic** | `CTrx` class | [NFU.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBClasses/NFU.cs) (`CNFU`) |
| **XML Serialization** | [TS_Export.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBExport/TS_Export.cs) | SP-generated (DB-side) |
| **File Generation** | [COrder.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/COrder.cs) | [CXM.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/CXM.cs) |
| **Windows Service** | [VieFUNDIE.cs](file:///c:/Users/NR/Desktop/VieFundAG/VieFUNDIE/VieFUNDIE.cs) | Same service |
| **Schema version** | `tfs.xsd` Version="35" | `nfu.xsd` Version="35" |
| **Response Import** | [COrder.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/COrder.cs) `ImportXML()` → DR files | [CXM.cs](file:///c:/Users/NR/Desktop/VieFundAG/UBFFImport/CXM.cs) `ImportXML()` → XR files |
