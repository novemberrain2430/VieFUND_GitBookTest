...
> **Nguồn**: [FundServ_OrderFlow.docx.md](../../business-logic-topics/fundserv-order-flow.md) — "Fund Companies ⬄ FundServ ⬄ Back Office System (like VieFUND)"
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) — methods `Buy()` (L611-739), `Sell()` (L985-1114), `Switch()` (L1232-1356), `Transfer()` (L1592-1707), `ICT()` (L1816-1895), `StockOrderAdd()` (L741-805)
...
> **Nguồn**: [FundServ_OrderFlow.docx.md](../../business-logic-topics/fundserv-order-flow.md) — "When an order is created: it has 'Pending' status... At T+1... the trx will have the status 'Contracted'... On T+2 TS file comes and the trx status changed to 'Confirmed'"
...
> **Nguồn**: [FundServ_OrderFlow.docx.md](../../business-logic-topics/fundserv-order-flow.md) — "Interactive (real time): using IBM Websphere Msg Queue... Batch: order file (called CO file)"
...
> **Nguồn**: [ERROR CORRECTION.md](../../business-logic-topics/error-correction.md) — "REV: reversal is a cancellation of a valid trade. The trade is already settled"

### 4.3. AOT — As of Trade

Order "back-dated" — dùng giá (NAV) của ngày trước đó.

> **Nguồn**: [ERROR CORRECTION.md](../../business-logic-topics/error-correction.md) — "AOT: As of Trade: basically it is a back dated order. For example: Today is April 25 but I order for April 15 trade date."

### 4.4. Dilution

Chênh lệch giá mà dealer phải chịu khi AOT/REV/CAX:

> **Ví dụ** (từ [ERROR CORRECTION.md](../../business-logic-topics/error-correction.md)):
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L807-858 — `AllowableAction()` method
...
> **Nguồn**: [PopupTradeAdd.aspx.cs](../../WebApp/Main/PopupTradeAdd.aspx.cs) L42-54 — tab declarations `idTabBuy`, `idTabSell`, `idTabSwitch`, `idTabTransfer`, `idTabICT`
...
> **Nguồn**: [PopupTradeAdd.aspx.cs](../../WebApp/Main/PopupTradeAdd.aspx.cs) L424-727 — `Page_Load()` method
...
> **Nguồn**: [PopupTradeAdd.aspx.cs](../../WebApp/Main/PopupTradeAdd.aspx.cs) L445-677
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L611-710 — `Buy()` method signature và SP params
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L1249 — comment trong `Switch()` method
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L1592-1607 — `Transfer()` method signature
...
> **Nguồn**: [ETF Transfer.docx.md](../../business-logic-topics/etf-transfer.md) — "ETF is traded on stock exchange... the trades do not go through FundServ, instead it goes via a third-party stock trading company"
...
> **Nguồn**: [ETF Transfer.docx.md](../../business-logic-topics/etf-transfer.md) L23-81
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) — public method signatures (extracted via grep)
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L2040-2165 — `GetViewList()` method
...
> **Nguồn**: [Trx.cs](../../UBClasses/Trx.cs) L3056-3075 — `ManualUpdate()` signature. SP name selected at L3080: `iTrxID > 0 ? "UBFundTrxManualUpdate" : "UBFundTrxManualAdd"`
...
> **Nguồn**: [PopupTradeAdd.aspx.cs](../../WebApp/Main/PopupTradeAdd.aspx.cs) L679-689 — settlement method dropdown manipulation; [Trx.cs](../../UBClasses/Trx.cs) — `SettlementInd`, `SettlementSource`, `SettlementMethod` params
...
> **Nguồn**: [FundServ_OrderFlow.docx.md](../../business-logic-topics/fundserv-order-flow.md) — "Mutual fund price is evaluated after 4 pm... ETF: it is like stock... GIC: the product rate is updated on a daily basis"
...
| Tài liệu | Liên quan |
|---|---|
| [Domain Glossary](../../getting-started/domain-glossary.md) | Định nghĩa thuật ngữ: Trx, NAV, Settlement, AOT, REV... |
| [System Map](../../getting-started/system-map.md) | Vị trí `Trx.cs` trong architecture |
| [ERROR CORRECTION.md](../../business-logic-topics/error-correction.md) | AOT/REV/CAX chi tiết + ví dụ dilution |
| [FundServ_OrderFlow.docx.md](../../business-logic-topics/fundserv-order-flow.md) | Order lifecycle, pricing, FundServ modes |
| [ETF Transfer.docx.md](../../business-logic-topics/etf-transfer.md) | ETF transfer rules, omnibus, FIX protocol |
